...
describe('Ensembles', () => {
  ...
  const model1: ModelLink<boolean, number, boolean> = {
    ...
    name: 'model1',
    model: 'model1',
    input: (x: boolean) => [{role: Speaker.USER, content: String(x)}],
  ...
  const model2: ModelLink<number, string, boolean> = {
    ...
    name: 'model2',
    model: 'model2',
    input: (x: number) => [{role: Speaker.USER, content: String(x)}],
    ...
    describe('ModelLink', () => {
      it('basic usage', async () => {
        ...
        const expectedResult: ProcessType<typeof model1> = {
          ...
          name: 'model1',
          input: true,
          prompt: [{role: Speaker.USER, content: 'true'}],
      ...
      it('basic usage', async () => {
        ...
        const expectedResult: ProcessType<typeof sequence1> = {
          ...
          left: {
            ...
            name: 'model1',
            input: false,
            prompt: [{role: Speaker.USER, content: 'false'}],
            completion: 'No way',
            output: 6,
            expected: 5,
            judgment: false,
          ...
          right: {
            ...
            name: 'model2',
            input: 6,
            prompt: [{role: Speaker.USER, content: '6'}],
            completion: 'true',
            output: 'true',
            expected: 'hi',
            judgment: false,
        ...
        const expectedResult: ProcessType<typeof mux1> = {
          ...
          children: [
            ...
            },
            {
              ...
              name: 'model2',
              input: 5,
              prompt: [{role: Speaker.USER, content: '5'}],
              completion: 'error',
              output: 'error',
              expected: 'hi',
              judgment: false,
